...
# MAGIC %md
# MAGIC 
# MAGIC #### Reading Previous Data Form ADLS 2

# COMMAND ----------

file_path = '/mnt/files/processedData/processedData.csv'
old_df = spark.read.csv(file_path, inferSchema=True, header=True)
old_df.printSchema()
...
# pdf = sdf.toPandas()
rawInputPath = '/dbfs/mnt/files/rawInput/rawInput.csv'
rawInputPath
sdf.toPandas().to_csv(rawInputPath, index = False, header=True)
...
# rawInputPath
processedDataPath = '/dbfs/mnt/files/processedData/processedData.csv'
final_sdf.toPandas().to_csv(processedDataPath, index=False, header=True)
